...
import { getSingleBrandData, selectBrand, selectBrandProducts } from "@/lib/features/brand/brandSlice"
...
export const SeeSingleBrandUser:React.FC = () => {
            ...
            <div className="container">
                <div className="show__wrapper">
                    <div className="show__title">
                        <h1 className="text-xl font-semibold text-center text-white">About {brand.name}</h1>
                    </div>

                    <div className="show__products">
                        {brandProducts?.map(elm => {
                            return(
